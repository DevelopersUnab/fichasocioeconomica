...
<body>
    <div>
        <table width="100%" style="text-align: center;">
            <tr>
                <td>
                    <img src="{{ asset('images/logoperu.png') }}" width="75" height="75">
                </td>
                <td>
                ...
                <td>
                    <img src="{{ asset('images/logounabchico.jpeg') }}" width="75" height="75">
                </td>
            </tr>
        </table>
        <hr>
        <p style="color: #000000; text-align: center;font-style: oblique;font-size: 14px;">{{$semestrenombreanio}}</p>
        <br>
        ...
        <br>
        <p style="color: #000000; text-align: center;">Por haber culminado satisfactoriamente el registro de la FICHA SOCIOECONÓMICA a través de la plataforma Virtual para el proceso de Matrícula {{$semestre}}.</p>
        <br>
        <p style="color: #000000; text-align: center;font-style: oblique;"><strong>GRACIAS POR SU IMPORTANTE PARTICIPACIÓN</strong></p>
        <div align="center">
                {!! str_replace('<?xml version="1.0" encoding="UTF-8"?>','',QrCode::size(180)->generate(Request::url())); !!}
        </div>
    </div>
</body>
</html>
