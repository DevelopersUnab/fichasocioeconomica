...
class CT_FSE705 extends Controller
{
    ...
    public function index()
    {
        ...
        return view('reportes.VB_FSE705')->with('modulos', $modulos)->with('modulos2', $modulos2)->with('modulos3', $modulos3)->with('estados', $estados)->with('procesos', $procesos);
    }

    public function listarfichasCalificadasDatos(Request $request){
        $proceso=$request->txtproceso;
        $fichas = (DB :: select( DB :: raw ("CALL P_LIS_FSE_FICHA_CALIFICADAS_DATOS($proceso)")));
